...
public class CollectionMapDemo {
    ...
    static void map() {
        ...
        System.out.println("putIfAbsent = " + map.putIfAbsent(8, "ry") + " now map.get(8)= " + map.get(8));
        map.forEach((e, r) -> System.out.println("qqd=" + e + r));
        System.out.println("computeIfPresent = " + map.computeIfPresent(2, (k, v) -> null));
        map.forEach((e, r) -> System.out.println("dfd=" + e + r));
        System.out.println("map merge: " + map.merge(4, "P", String::concat));
        System.out.println("map merge: " + map.merge(6, "Oo", String::concat));
